basedir=/srv/scratch/annashch/deeplearning/dmso
...
#Old keras compatibility 
#CUDA_VISIBLE_DEVICES=0 python runModelPureKerasOld.py --train_path $basedir/inputs/s_by_m_by_pos/normalized.dmso.train.hdf5 --valid_path $basedir/inputs/s_by_m_by_pos/normalized.dmso.validate.hdf5 --model_output_file $basedir/purekeras.OLD.graph.1e-6.hdf5 --model_builder dmso_legacy_graph_modelOld.py --w0_file $base_dir/w0.txt --w1_file $base_dir/w1.txt --batch_size 1000

#LEGACY GRAPH MODEL
#CUDA_VISIBLE_DEVICES=7 python runModelPureKeras.py --train_path inputs/s_by_m_by_pos/normalized.dmso.train.hdf5 --valid_path inputs/s_by_m_by_pos/normalized.dmso.validate.hdf5 --model_output_file purekeras.NEW.graph.1e-6.hdf5 --model_builder dmso_legacy_graph_model.py --w0_file w0.txt --w1_file w1.txt --batch_size 1000
