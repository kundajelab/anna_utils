...
def parse_args():
    ...
    parser.add_argument("--test_hdf5",default=None)
    parser.add_argument("--valid_hdf5",default=None)
    parser.add_argument("--out_normalized_train_hdf5")
    parser.add_argument("--out_normalized_valid_hdf5",default=None)
    parser.add_argument("--out_normalized_test_hdf5",default=None)
...
def main():
    ...
    if args.valid_hdf5!=None:
        valid_data=h5py.File(args.valid_hdf5,'r')
    if args.test_hdf5!=None: 
